...
class ultra_lane():
    ...
    def train(self, config):
        ...
        with tf.device(config['device']):
            ...
            valid_src_img_queue, valid_label_queue, valid_cls_queue = pipe_handle.make_pipe(config['eval_batch_size'], (valid_src_tensor, valid_label_tensor, valid_cls_tensor), valid_data_handle.pre_process_img)
